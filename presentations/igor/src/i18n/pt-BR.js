export default {
  ...
  profile: {
    tag: 'Quem é',
    name: 'Igor Fernandes',
    nameFull: 'Igor Fernandes Gonçalves',
    role: 'Engenheiro de QA Pleno',
    description:
      'São mais de 7 anos trabalhando com qualidade de software. Formado em Ciência da Computação, o Igor atua com testes ponta a ponta, automação Web e API, testes de carga e estratégia de qualidade com cultura Shift Left. Trabalha com Scrum e Kanban no dia a dia, e manja de ferramentas como Selenium, Appium, Rest-Assured, JMeter, K6 e Cucumber.',
    highlights: [
      { label: 'Experiência', value: '+7 anos em QA' },
      { label: 'Formação', value: 'Ciência da Computação (FUCAPI)' },
      { label: 'Inglês', value: 'Full Professional' },
    ],
    companies: 'Venturus, Trademaster, iTRIAD, LAMPP-IT, PRODAM-AM',
    skills:
      'Selenium WebDriver, Appium, Rest-Assured, JUnit, Cucumber, JMeter, K6, Postman, JavaScript, Python, Azure DevOps, Jira, Confluence, Jenkins, Git, Maven, BDD/Gherkin',
    current:
      'Hoje está na Venturus como Engenheiro de QA Pleno, puxando a estratégia de qualidade com Shift Left, modelagem de testes e integração de pipelines.',
  },

  whyHere: {
    tag: 'Por que o Igor está aqui hoje?',
    headline: 'Para transformar +7 anos de experiência',
    headlineBold: 'em posicionamento internacional de alto valor.',
    points: [
      'Ele já tem uma stack técnica sólida (automação, API, performance, mobile) e inglês profissional. O que falta é o posicionamento certo pro mercado global.',
      ...
      'Com o perfil que o Igor já tem, a distância entre onde ele está e uma vaga nearshore é bem menor do que ele imagina.',
    ],
    closing:
      'Quem já tem a base técnica e o inglês, só precisa do direcionamento certo. E o Igor está no momento ideal pra dar esse salto.',
  },
  ...
  salary: {
    ...
    closing:
      'Um QA Pleno trabalhando pra fora pode ganhar o equivalente a um Sênior ou mais aqui no Brasil. O Igor, com +7 anos de experiência, automação e inglês profissional, já tem tudo pra acessar essa faixa agora.',
  },
    ...
    steps: [
      {
        ...
        desc: '1 foco + 1 alternativa. Definir quem você é em 1 frase: QA Engineer Pleno com +7 anos em automação (Web, API, Mobile), testes de performance e estratégia de qualidade, pronto pro mercado internacional.',
      },
      {
        number: '02',
        label: 'LinkedIn/CV',
        desc: 'Montar uma narrativa que mostra resultado, escopo e impacto. Colocar em destaque a experiência com Shift Left, automação multiplataforma, pipelines de qualidade e a formação em Ciência da Computação.',
      },
      {
        number: '03',
  ...
  whyMentorship: {
    ...
    points: [
      'Porque o Igor já tem a base técnica robusta (+7 anos, automação, performance, Shift Left) e inglês profissional. Só falta o posicionamento e a estratégia certa pro mercado internacional.',
      'A mentoria te ajuda a transformar sua experiência brasileira em presença global, montar sua estratégia de aplicação e se preparar pra entrevistas internacionais com confiança.',
      'Com o perfil que o Igor já construiu, a primeira oportunidade internacional não é questão de "se", é questão de "quando". E a mentoria encurta esse caminho de forma drástica.',
    ],
  },
  ...
  closing: {
    text: 'Queremos ouvir de você Igor, o que achou?',
  },
};
