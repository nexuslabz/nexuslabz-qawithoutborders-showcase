export default {
  ...
  profile: {
    tag: 'Quem é',
    name: 'Bruno Purper',
    nameFull: 'Bruno Purper',
    role: 'QA Automation Engineer | +9 anos em tecnologia | +4 anos em QA & Automação',
    description:
      'O Bruno é um QA que veio do desenvolvimento. Com background como full stack developer e mais de 4 anos focado em qualidade e automação, ele já atua em sistemas globais de alta complexidade. Passou pela HP, onde garantiu qualidade pro HP Smart (usado por mais de 13 milhões de pessoas), e hoje está na ADP automatizando workflows críticos pra grandes empresas. Redesenhou a arquitetura de automação com Playwright e conseguiu 40% de redução no tempo de execução dos testes. Já usa inglês no dia a dia profissional. O que falta é o posicionamento certo pra acessar vagas internacionais no nível que ele merece.',
    highlights: [
      { label: 'Experiência', value: '+9 anos em tecnologia, +4 em QA & Automação' },
      { label: 'Formação', value: 'Análise e Desenvolvimento de Sistemas (UNIASSELVI)' },
      { label: 'Inglês', value: 'Profissional (uso diário em equipe global)' },
    ],
    companies: 'ADP, HP, SSolutions, Startaideia',
    skills:
      'Playwright, Cypress, Selenium, TypeScript, Jenkins, Docker, Jira, Confluence, Postman, BDD, CI/CD, React.js, Java',
    current:
      'Hoje atua como QA Automation Engineer na ADP, automatizando workflows críticos em sistemas globais de alta complexidade para grandes empresas. Redesenhou a arquitetura de automação com Playwright e implementou melhorias de performance significativas.',
  },

  whyHere: {
    tag: 'Por que o Bruno está aqui hoje?',
    headline: 'Para transformar sua experiência sólida em QA e automação',
    headlineBold: 'em uma carreira internacional com salário em dólar.',
    points: [
      'O Bruno já está trabalhando com automação em nível global. Na HP, garantiu qualidade de um produto com 13 milhões de usuários. Na ADP, automatiza workflows críticos pra clientes como a Amazon. O problema não é competência técnica. É que o mercado internacional não sabe que ele existe.',
      'Ele tem um diferencial que poucos QAs brasileiros têm: background de desenvolvedor. Isso dá pra ele a visão completa do ciclo, desde o código até o teste. No mercado internacional, o perfil de QA que entende de código vale muito mais.',
      'Com inglês já sendo usado no dia a dia, domínio de Playwright, Cypress e CI/CD, e experiência em empresas globais, o Bruno tem tudo pra acessar vagas pleno/senior remotas. Falta traduzir essa bagagem pro formato que recrutadores internacionais esperam.',
    ],
    closing:
      'Quem já trabalha em produtos globais com milhões de usuários não precisa provar que sabe. Precisa de visibilidade no lugar certo. E o Bruno está pronto pra isso.',
  },
  ...
  salary: {
    ...
    closing:
      'O Bruno está na transição de pleno pra sênior, com experiência em empresas globais e automação avançada. No mercado internacional, esse perfil acessa a faixa de US$ 3–6k/mês como pleno, chegando a US$ 7.5k como sênior. No Brasil, o mesmo nível fica em torno de R$ 6–8k. A diferença é brutal.',
  },
    ...
    steps: [
      {
        ...
        desc: '1 foco + 1 alternativa. Definir quem o Bruno é em 1 frase: QA Automation Engineer / SDET com +4 anos de automação, background de developer, e experiência em sistemas globais com milhões de usuários (HP Smart, ADP).',
      },
      {
        number: '02',
        label: 'LinkedIn/CV',
        desc: 'Reconstruir o perfil pra destacar impacto técnico: redesenho de framework com 40% de ganho de performance, agentes de IA para triage de bugs, automação em escala global. Mostrar o background dev como diferencial.',
      },
      {
        number: '03',
        label: 'Inglês na prática',
        desc: 'O Bruno já usa inglês no trabalho. O foco é polir o vocabulário técnico de QA: daily, bug report, test strategy, comunicação com stakeholders. Com scripts e simulações pra ganhar ainda mais confiança.',
      },
      {
        number: '04',
        label: 'Execução internacional',
        desc: 'Montar a estratégia de aplicação: onde aplicar, como se posicionar como SDET, como responder recruiter e manter consistência. Com mock interviews focadas e feedback semanal.',
      },
    ],
  },
  ...
  howItWorks: {
    ...
    items: [
      ...
      {
        title: 'Masterclass',
        desc: 'Sessões ao vivo com convidados e resolução de casos reais',
      },
      {
        title: 'Comunidade',
      ...
      {
        title: 'Grupo VIP de Mentorados',
        desc: 'Acesso exclusivo ao grupo de mentorados com troca de experiências, oportunidades e suporte entre pares',
      },
      {
  ...
  whyMentorship: {
    ...
    points: [
      'Porque o Bruno já tem o que o mercado internacional procura: automação moderna (Playwright, Cypress), experiência em produtos globais e inglês profissional. O que falta é visibilidade. Recrutadores internacionais não vão encontrar ele se o perfil estiver formatado pro mercado local.',
      'A mentoria ajuda a traduzir a bagagem técnica pro formato que gera entrevistas e propostas. Não é sobre aprender QA. É sobre mostrar o impacto real que ele já entrega, de um jeito que recrutadores lá fora entendem.',
      'Com o background de developer e a experiência em automação em escala, o Bruno tem um perfil raro. A mentoria encurta o caminho pra primeira oportunidade internacional com estratégia, execução guiada e acesso direto a quem já está no mercado global.',
    ],
  },
  ...
  closing: {
    text: 'Queremos ouvir de você Bruno, o que achou?',
  },
};
