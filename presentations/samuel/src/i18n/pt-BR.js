export default {
  ...
  profile: {
    tag: 'Quem é',
    name: 'Samuel Lima',
    nameFull: 'Samuel Lima',
    role: 'QA Engineer | SDET | +7 anos em TI',
    description:
      'O Samuel é QA Engineer com foco forte em automação de testes. Trabalha com Playwright, Cypress, Selenium e Postman no dia a dia. Tem um diferencial que pouca gente tem: além de QA, já atuou como desenvolvedor (Java, JavaScript) e como Product Owner, o que dá pra ele uma visão completa do ciclo de desenvolvimento. Formado em Ciência da Computação com pós em Desenvolvimento Mobile, tem mais de 3 anos dedicados a QA e automação.',
    highlights: [
      { label: 'Experiência', value: '+3 anos em QA e automação' },
      { label: 'Formação', value: 'Ciência da Computação + Pós em Dev Mobile' },
      { label: 'Inglês', value: 'Professional Working' },
    ],
    skills:
      'Playwright, Cypress, Selenium, Postman, Appium, Robot, Java, JavaScript, Python, JUnit, Rest-Assured, SQL, Gherkin',
    current:
      'Hoje atua como QA Engineer na Integrado, onde faz testes web e API Rest com Playwright e Cypress, automação de testes, testes de performance, regressão, usabilidade e participa da definição de requisitos.',
  },

  whyHere: {
    tag: 'Por que o Samuel está aqui hoje?',
    headline: 'Para transformar sua experiência em QA e automação',
    headlineBold: 'em uma carreira internacional ganhando em dólar.',
    points: [
      'O Samuel já tem as ferramentas que o mercado internacional pede: Playwright, Cypress, Selenium, Postman. Mas o mercado lá fora não sabe que ele existe. O LinkedIn, o currículo e o posicionamento estão formatados pro mercado brasileiro.',
      'Ele tem um diferencial raro: passou por desenvolvimento e por Product Owner antes de focar em QA. Isso dá uma visão de produto e engenharia que recrutadores internacionais valorizam muito. Só que isso não está aparecendo do jeito certo.',
      'Com inglês profissional, formação sólida e stack moderna de automação, o Samuel tem tudo pra acessar vagas remotas pra fora. Falta o posicionamento estratégico e a execução certa pra colocar isso em prática.',
    ],
    closing:
      'O Samuel já tem a base técnica e a visão de produto. O que falta é mostrar isso pro mercado certo, do jeito certo.',
  },
  ...
  salary: {
    ...
    closing:
      'O Samuel está na transição de pleno pra sênior, com stack moderna de automação e visão de produto. No mercado internacional, esse perfil acessa a faixa de US$ 3–6k/mês como pleno, podendo chegar a US$ 7.5k como sênior. No Brasil, esse mesmo nível fica entre R$ 6–8k. A diferença é enorme.',
  },
    ...
    steps: [
      {
        ...
        desc: '1 foco + 1 alternativa. Definir quem o Samuel é em 1 frase: QA Engineer / SDET com +3 anos de automação (Playwright, Cypress, Selenium), background de desenvolvedor e Product Owner, formação em Ciência da Computação e inglês profissional.',
      },
      {
        number: '02',
        label: 'LinkedIn/CV',
        desc: 'Reconstruir o perfil pra destacar o que o mercado internacional valoriza: automação moderna, visão de produto, experiência com múltiplas stacks e resultados concretos. Mostrar que ele não é só um executor, tem visão completa do ciclo.',
      },
      {
        number: '03',
        label: 'Inglês na prática',
        desc: 'O Samuel já tem inglês profissional. O foco aqui é afinar o vocabulário técnico de QA: daily, bug report, test strategy, comunicação com devs e stakeholders. Com scripts e simulações pra ficar natural no contexto de trabalho.',
      },
      {
        number: '04',
        label: 'Execução internacional',
        desc: 'Montar a estratégia de aplicação: onde aplicar, como se apresentar, como responder recruiter, e manter consistência. Com mock interviews focadas em perfis de automação e feedback semanal.',
      },
    ],
  },
  ...
  whyMentorship: {
    ...
    points: [
      'Porque o Samuel já tem a stack que o mercado internacional procura: Playwright, Cypress, Selenium, Postman. E ainda tem a visão de produto que vem da experiência como PO. O que falta é colocar tudo isso no radar dos recrutadores certos.',
      'A mentoria ajuda a transformar a experiência do Samuel num perfil que gera entrevistas. Não é sobre aprender novas ferramentas. É sobre mostrar o que ele já sabe de um jeito que o mercado lá fora entende e valoriza.',
      'Com o perfil do Samuel, a primeira oportunidade internacional é questão de posicionamento e execução. A mentoria encurta esse caminho com estratégia, prática e acesso direto a quem já está no mercado global.',
    ],
  },
  ...
  closing: {
    text: 'Queremos ouvir de você Samuel, o que achou?',
  },
};
