export default {
  ...
  profile: {
    tag: 'Quem é',
    name: 'Fernando Kawakami',
    nameFull: 'Fernando Kawakami',
    role: 'Senior QA Engineer | +18 anos de experiência',
    description:
      'O Fernando é um QA de verdade, com mais de 18 anos de estrada. Já passou por empresas como HP, TCS, NTT DATA e Genial Investimentos. Sabe montar plano de teste do zero, gerenciar ciclos de defeitos, rodar regressão, smoke, E2E, API. Já trabalhou com implantação de fábrica de testes e até mentorou equipes. É engenheiro da computação formado, tem MBA em gestão de TI e fala inglês fluente. O que falta é o posicionamento certo pra mostrar tudo isso pro mercado lá fora.',
    highlights: [
      { label: 'Experiência', value: '+18 anos em QA (desde 2006)' },
      { label: 'Formação', value: 'Eng. da Computação + MBA em Gestão de TI' },
      { label: 'Inglês', value: 'Full Professional' },
    ],
    companies: 'Fóton, TCS, NTT DATA, Genial, HP, CSC, Mirante',
    skills:
      'Cypress, Azure DevOps, Mobile Center, Octane, Postman, BDD, RQM, Jira, Xray, Power BI, Testes Funcionais, Regressão, E2E, API, Mobile',
    current:
      'Hoje atua como Senior Software Tester na Fóton Informática, onde cria planos de teste em BDD com RQM, executa testes funcionais e de back-end com Postman, e gerencia ciclos de defeitos.',
  },

  whyHere: {
    tag: 'Por que o Fernando está aqui hoje?',
    headline: 'Para transformar mais de 18 anos de experiência sólida em QA',
    headlineBold: 'em uma carreira internacional com o reconhecimento que merece.',
    points: [
      'O Fernando não precisa aprender QA. Ele respira isso há quase duas décadas. O ponto é que todo esse conhecimento está "escondido" pro mercado internacional. O currículo, o LinkedIn e o posicionamento estão formatados pro mercado local.',
      'Ele já trabalhou em empresas grandes, já liderou times, já implantou fábricas de testes. Mas nada disso aparece da forma que recrutadores internacionais esperam ver. Falta traduzir essa trajetória pro formato que o mercado global entende.',
      'Com inglês fluente, formação forte (Engenharia + MBA), certificação AWS e experiência com ferramentas que o mercado lá fora usa no dia a dia, o Fernando tem tudo pra acessar vagas senior/lead remotas. Só precisa do direcionamento certo.',
    ],
    closing:
      'Quem tem 18 anos de experiência não precisa provar competência. Precisa de visibilidade no lugar certo. E o Fernando está pronto pra isso.',
  },
  ...
  salary: {
    ...
    closing:
      'O Fernando já é senior com 18 anos de bagagem. No mercado internacional, esse perfil acessa a faixa de US$ 7.5–8k/mês, que é mais de R$ 38k. No Brasil, esse mesmo nível fica em torno de R$ 10–12k. A diferença é gritante, e ele já tem tudo pra acessar essa faixa.',
  },
    ...
    steps: [
      {
        ...
        desc: '1 foco + 1 alternativa. Definir quem o Fernando é em 1 frase: Senior QA Engineer com +18 anos de experiência em testes funcionais, E2E, API e mobile, com vivência em empresas globais como HP e TCS, formação em Engenharia e inglês fluente.',
      },
      {
        number: '02',
        label: 'LinkedIn/CV',
        desc: 'Reconstruir o perfil pra destacar o que o mercado internacional valoriza: impacto nos projetos, ferramentas modernas, liderança técnica e certificações. Montar uma narrativa que mostra a profundidade da experiência.',
      },
      {
        number: '03',
        label: 'Inglês na prática',
        desc: 'O Fernando já tem inglês fluente. O foco aqui é afinar o vocabulário técnico de QA: daily, bug report, test strategy, comunicação com devs e stakeholders. Com scripts e simulações pra ficar natural no contexto de trabalho.',
      },
      {
        number: '04',
        label: 'Execução internacional',
        desc: 'Montar a estratégia de aplicação: onde aplicar, como se apresentar, como responder recruiter, e manter consistência. Com mock interviews focadas em perfis senior e feedback semanal.',
      },
    ],
  },
  ...
  whyMentorship: {
    ...
    points: [
      'Porque o Fernando já tem tudo que o mercado internacional pede: experiência sólida, formação forte, inglês fluente e domínio de ferramentas modernas. O que falta é visibilidade. Ninguém lá fora sabe que ele existe, e isso muda com o posicionamento certo.',
      'A mentoria ajuda a traduzir 18 anos de carreira pro formato que recrutadores internacionais entendem. Não é sobre aprender QA. É sobre mostrar o que ele já sabe de um jeito que gere entrevistas e propostas.',
      'Com o perfil do Fernando, a primeira oportunidade internacional não é questão de "se", é questão de "quando". E a mentoria encurta esse caminho com estratégia, execução guiada e acesso direto a quem já está no mercado global.',
    ],
  },
  ...
  closing: {
    text: 'Queremos ouvir de você Fernando, o que achou?',
  },
};
