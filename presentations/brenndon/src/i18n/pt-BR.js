export default {
  ...
  profile: {
    tag: 'Quem é',
    name: 'Brenndon Cezar',
    nameFull: 'Brenndon De Castro Cezar',
    role: 'Tech Recruiter em transição para QA',
    description:
      'O Brenndon vem de uma trajetória que poucos QAs conseguem ter: ele conhece o mercado de tech por dentro, do lado de quem contrata. Como Tech Recruiter, já conduziu dezenas de processos seletivos pra vagas de QA, participou de entrevistas técnicas e validou cases de candidatos. Hoje quer mudar de lado e virar o profissional que ele mesmo recrutava.',
    highlights: [
      { label: 'Experiência', value: 'Tech Recruiter + Suporte (Dynamics AX 2012)' },
      { label: 'Formação', value: 'Eng. de Produção + ADS (cursando)' },
      { label: 'Inglês', value: 'Avançado (Full Professional)' },
    ],
    companies: 'UDS Tecnologia, Mereo, INFRA HUMANA RH',
    skills:
      'Recrutamento Tech, Python, SQL, APIs, Dynamics AX 2012, Testes Manuais, ISTQB Syllabus, Entrevistas Técnicas, LinkedIn Recruiter, ATS',
    current:
      'Hoje atua como Tech Recruiter na UDS Tecnologia e também trabalha com suporte em Dynamics AX 2012, onde já participa informalmente de testes em homolog antes de subir pra produção.',
  },

  whyHere: {
    tag: 'Por que o Brenndon está aqui hoje?',
    headline: 'Para transformar uma visão privilegiada do mercado de QA',
    headlineBold: 'em uma carreira internacional na área.',
    points: [
      'O Brenndon já vive no ecossistema de tech. Como recruiter, ele entende o que as empresas buscam num QA, sabe ler job descriptions, conhece os filtros de ATS e já participou de entrevistas técnicas do outro lado da mesa. Agora quer aplicar tudo isso a favor da própria carreira.',
      'Além disso, ele já testa no dia a dia. No suporte ao Dynamics AX 2012, participa de validações em homolog antes de mandar pra produção. Falta formalizar essa experiência e construir o posicionamento certo.',
      'Com inglês avançado, base técnica (Python, SQL, APIs), formação em Engenharia de Produção e a vivência de quem já recrutou QAs, o Brenndon tem um perfil raro. Ele só precisa da estratégia certa pra entrar no mercado internacional.',
    ],
    closing:
      'Quem conhece o jogo por dentro e agora quer jogar, só precisa do direcionamento certo. E o Brenndon está pronto pra isso.',
  },
  ...
  salary: {
    ...
    closing:
      'Um QA Junior trabalhando pra fora já pode ganhar mais do que muitos profissionais sênior no Brasil. O Brenndon, com inglês avançado e vivência no ecossistema de tech, tem tudo pra acessar essa faixa com o posicionamento certo.',
  },
    ...
    steps: [
      {
        ...
        desc: '1 foco + 1 alternativa. Definir quem você é em 1 frase: profissional em transição pra QA com visão de mercado de quem já recrutou dezenas de QAs, base técnica (Python, SQL, APIs) e inglês avançado.',
      },
      {
        number: '02',
        label: 'LinkedIn/CV',
        desc: 'Construir um perfil de QA do zero, sem queimar o LinkedIn atual. Montar uma narrativa que mostra a visão única de quem conhece o mercado por dentro e agora quer atuar nele.',
      },
      {
        number: '03',
        label: 'Inglês na prática',
        desc: 'O Brenndon já tem inglês avançado. O foco aqui é ajustar o vocabulário técnico de QA: daily, bug report, test strategy, comunicação com devs. Com scripts e simulações pra ficar natural.',
      },
      {
        number: '04',
        label: 'Execução internacional',
        desc: 'Montar sua estratégia de aplicação: onde aplicar, como se apresentar, como responder recruiter (ele já sabe como eles pensam!) e manter consistência. Com mock interviews e feedback semanal.',
      },
    ],
  },
  ...
  whyMentorship: {
    ...
    points: [
      'Porque o Brenndon já vive no ecossistema de tech e conhece o mercado de QA pelo lado de quem contrata. Já participou de entrevistas técnicas, validou cases e sabe o que recrutadores buscam. Agora é hora de usar essa vantagem a favor da própria carreira.',
      'A mentoria ajuda a transformar essa visão privilegiada em posicionamento real: construir o perfil de QA do zero, formalizar a experiência com testes e se preparar pro mercado internacional com quem já está lá.',
      'Com inglês avançado, base técnica (Python, SQL, APIs), formação em Engenharia de Produção e uma visão que poucos QAs juniors conseguem ter, a primeira oportunidade internacional é questão de estratégia. E a mentoria entrega exatamente isso.',
    ],
  },
  ...
  closing: {
    text: 'Queremos ouvir de você Brenndon, o que achou?',
  },
};
