export default {
  ...
  profile: {
    ...
    description:
      'QA Analyst em início de carreira, trabalhando em ambientes ágeis com Scrum. Faz testes manuais e funcionais em plataformas mobile (Android, iOS, Mac), testes de API com Postman e cria cenários com BDD/Gherkin. Organizado, comunicativo e focado em melhoria contínua.',
    highlights: [
    ...
    current:
      'Hoje está na BR Gaap Corporation como Junior QA Analyst, fazendo testes funcionais, regressivos e exploratórios em ambiente ágil com Scrum.',
  },
  ...
  whyHere: {
    ...
    points: [
      'Ele já está construindo uma base sólida com BDD, testes de API e mobile. Agora precisa de direcionamento prático do que dá retorno no mercado.',
      'A mentoria ajuda a criar stack e portfólio de QA moderno (rotina, projetos e narrativa) e preparar o caminho pra oportunidades maiores.',
      'Começar cedo com posicionamento correto encurta em anos o caminho pro mercado internacional.',
    ],
  ...
  salary: {
    ...
    closing:
      'Um QA Júnior trabalhando pra fora pode encostar na faixa de Sênior aqui no Brasil. O Pedro, com o posicionamento certo desde agora, pode acessar essa faixa muito mais rápido do que a média.',
  },
    ...
    steps: [
      {
        ...
        desc: '1 foco + 1 alternativa. Definir quem você é em 1 frase: Junior QA Analyst com base sólida em BDD, testes mobile e API, buscando crescimento acelerado no mercado internacional.',
      },
      {
        number: '02',
        label: 'LinkedIn/CV',
        desc: 'Montar uma narrativa que mostra resultado, escopo e impacto. Colocar em destaque a base em Scrum, BDD/Gherkin, testes multiplataforma e a formação em Engenharia de Software.',
      },
      {
        number: '03',
  ...
  whyMentorship: {
    ...
    points: [
      ...
      'A mentoria ajuda a criar stack e portfólio de QA moderno (rotina, projetos e narrativa) e preparar o caminho pra oportunidades maiores, incluindo uma trilha futura pro mercado internacional.',
