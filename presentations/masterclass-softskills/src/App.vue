...
import ObjectivesSection from './sections/ObjectivesSection.vue';
import PillarsSection from './sections/PillarsSection.vue';
import ModulesSection from './sections/ModulesSection.vue';
import Module1Section from './sections/Module1Section.vue';
import Module2Section from './sections/Module2Section.vue';
import Module3Section from './sections/Module3Section.vue';
import Module3bSection from './sections/Module3bSection.vue';
import Module45Section from './sections/Module45Section.vue';
import Module6Section from './sections/Module6Section.vue';
