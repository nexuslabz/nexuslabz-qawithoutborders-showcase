export default {
  ...
  profile: {
    tag: 'Quem é',
    name: 'Marcelo Pires',
    nameFull: 'Marcelo Pires',
    role: 'QA Automation Engineer | +5 anos em automação',
    description:
      'O Marcelo é um QA focado em automação que já trabalha na Globant, uma das maiores consultorias de tecnologia do mundo. Automatiza testes de API com RestAssured, web com Selenium e mobile com Appium. Trabalha com CI/CD integrando BitBucket e Bamboo, e já passou por empresas como Platform Builders, Prime Control e Zallpy Digital. Tem domínio de múltiplas linguagens (Java, JavaScript, Python) e frameworks (Robot Framework, Cucumber). Formado em ADS pela FIAP e com inglês profissional.',
    highlights: [
      { label: 'Experiência', value: '+5 anos em automação de testes' },
      { label: 'Formação', value: 'ADS pela FIAP' },
      { label: 'Inglês', value: 'Professional Working' },
    ],
    companies: 'Globant, Platform Builders, Zallpy, Prime Control, Auditeste',
    skills:
      'Selenium, Robot Framework, Appium, RestAssured, Cucumber, Java, JavaScript, Python, BitBucket, Bamboo, CI/CD, Citrix, Jira, Scrum, Kanban',
    current:
      'Hoje atua na Globant como QA Automation Engineer, automatizando testes de API com RestAssured, web com Selenium e mobile com Appium, além de integrar pipelines de CI/CD com BitBucket e Bamboo.',
  },

  whyHere: {
    tag: 'Por que o Marcelo está aqui hoje?',
    headline: 'Para transformar uma base sólida de automação e experiência em empresa global',
    headlineBold: 'em uma carreira internacional com salário em dólar.',
    points: [
      'O Marcelo já está dentro de uma empresa global. Na Globant, ele automatiza testes, trabalha com CI/CD e lida com clientes internacionais. Essa vivência é um diferencial enorme que a maioria dos QAs brasileiros não tem. Agora é hora de usar isso pra acessar oportunidades internacionais diretas.',
      'Ele tem um arsenal técnico forte: Selenium, Appium, RestAssured, Robot Framework, Cucumber, Java, Python, JavaScript. Sabe automatizar web, mobile e API. Isso é exatamente o que o mercado lá fora procura. O que falta é o posicionamento e a estratégia certa pra chegar nessas vagas.',
      'Com a experiência na Globant no currículo, formação pela FIAP e inglês profissional, o Marcelo tem um perfil competitivo pra vagas nearshore. A mentoria entra pra acelerar esse processo e garantir que ele chegue posicionado da forma certa.',
    ],
    closing:
      'Quem já trabalha numa empresa global e domina automação está a um passo do mercado internacional. O Marcelo só precisa da estratégia certa. E ele está pronto pra isso.',
  },
  ...
  salary: {
    ...
    closing:
      'O Marcelo já trabalha numa empresa global e domina automação em múltiplas linguagens. No mercado internacional, esse perfil acessa a faixa de pleno a sênior (US$ 3–8k/mês). No Brasil, o teto é bem mais baixo. Com o posicionamento certo, a diferença salarial é o primeiro resultado visível.',
  },
    ...
    steps: [
      {
        ...
        desc: '1 foco + 1 alternativa. Definir quem o Marcelo é em 1 frase: QA Automation Engineer com experiência em empresa global (Globant), domínio de Selenium, Appium e RestAssured, múltiplas linguagens e vivência com CI/CD.',
      },
      {
        number: '02',
        label: 'LinkedIn/CV',
        desc: 'Reconstruir o perfil destacando a experiência na Globant como prova de atuação internacional, o domínio de automação em web/mobile/API e a capacidade de trabalhar com pipelines de CI/CD. Montar uma narrativa que gera interesse em recrutadores.',
      },
      {
        number: '03',
        label: 'Inglês na prática',
        desc: 'O Marcelo já tem inglês profissional. O foco aqui é evoluir a comunicação técnica: daily, bug report, test strategy, pull request reviews. Com scripts e simulações pra ganhar confiança e fluência no contexto de trabalho.',
      },
      {
        number: '04',
        label: 'Execução internacional',
        desc: 'Montar a estratégia de aplicação: onde aplicar, como se apresentar, como responder recruiter, e manter consistência. Com mock interviews e feedback semanal pra refinar a performance.',
      },
    ],
  },
  ...
  whyMentorship: {
    ...
    points: [
      'Porque o Marcelo já trabalha numa empresa global e domina automação de testes em múltiplas linguagens e plataformas. Ele já tem a base técnica que o mercado internacional procura. O que falta é o posicionamento certo e a estratégia pra acessar oportunidades diretas com salário em dólar.',
      'A mentoria ajuda a transformar a experiência na Globant e o domínio técnico em automação num perfil que gera entrevistas internacionais. Não é sobre aprender mais ferramentas. É sobre mostrar o que ele já faz de um jeito que recrutadores lá fora entendam e valorizem.',
      'Com Globant no currículo, experiência em API/web/mobile automation, CI/CD e inglês profissional, a primeira oportunidade nearshore é questão de estratégia. E a mentoria entrega exatamente isso: direcionamento, execução guiada e acesso a quem já está no mercado global.',
    ],
  },
  ...
  closing: {
    text: 'Queremos ouvir de você Marcelo, o que achou?',
  },
};
