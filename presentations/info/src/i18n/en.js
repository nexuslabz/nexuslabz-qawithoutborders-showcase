export default {
  ...
  mentors: {
    tag: 'Who is behind the mentorship?',
    caio: {
      name: 'Caio Moloni',
      title: 'Founder',
      role: 'Senior QA',
  ...
  pillar8: {
    ...
    items: [
      ...
      'Hands-on experience with Web and Mobile applications in real testing scenarios',
  ...
  cta: {
    ...
    button: 'Schedule diagnostic call',
